...
export const formatStr = {
  ...
  customDateTime: 'DD/MM/YYYY [at] h:mm a', // 17/04/2025 at 7:55 pm
  tz: 'YYYY-MM-DDTHH:mm:ss[Z]',
};
 ...
 * output: '05:30'
 */
export function fMilli(ms: number): string {
...
export function formatDuration(seconds: number | string): string {
  const totalSeconds = Math.floor(Number(seconds)); // Convert and floor safely
